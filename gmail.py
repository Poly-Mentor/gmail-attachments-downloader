...
def main():
    ...
    parser.add_argument('-t', '--topic', default='saveit', help='Topic to search for in emails.')
    parser.add_argument('-u', '--unread-only', action='store_true', help='Search only unread emails.')
    parser.add_argument('-o', '--overwrite', action='store_true', help='Overwrite existing files.')
    parser.add_argument('-p', '--target-path', default='downloads', help='Target path for downloaded files.')
